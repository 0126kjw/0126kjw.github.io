...
Entity 경로를 수정한 후 Seeding을 해본 결과 에러가 뜨지 않고 정상적으로 Seeding 되는 것을 확인할 수 있었습니다.
...
데이터베이스에도 정상적으로 잘 저장된 것을 확인할 수 있었습니다.
...
TypeORM Seeding을 할 때는 다음과 같은 전역 변수를 지정해주어야 합니다.

저는 제 디렉토리 경로에 맞게 경로 수정 후 변수 지정하였습니다.
